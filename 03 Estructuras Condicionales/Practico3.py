...
contrasenia = input("Por favor, ingresa una contraseña: ")
...
#En este caso cree variables para probar su funcionamiento y hacer la condicion if mas entendible:
...
dia = int(input("¿Qué día es del mes?: "))
...
if hemisferio == "N":
    ...
    elif (mes == 9 and dia >= 23) or (mes in [10, 11]) or (mes == 12 and dia < 22):
        estacion = "Otoño"
    # Invierno: 22 diciembre - 19 marzo
    else:
        estacion = "Invierno"
    
elif hemisferio == "S": 
    # Otoño: 20 marzo - 20 junio
    if (mes == 3 and dia >= 20) or (mes in [4, 5]) or (mes == 6 and dia < 21):
        estacion = "Otoño"
    # Invierno: 21 junio - 22 septiembre
    elif (mes == 6 and dia >= 21) or (mes in [7, 8]) or (mes == 9 and dia < 23):
        estacion = "Invierno"
    # Primavera: 23 septiembre - 21 diciembre
    elif (mes == 9 and dia >= 23) or (mes in [10, 11]) or (mes == 12 and dia < 22):
        estacion = "Primavera"
    # Verano: 22 diciembre - 19 marzo
    else:
        estacion = "Verano"
